<?php
/*
Template Name: page-for-individuals
*/
?>
<?php get_header(); ?>
...
<main class="page about-page">
		...
		<div class="hero-about-page__container">
			<div class="hero-about-page__left">
				<div class="hero-home-page__box">
					<h1 data-watch="" data-watch-threshold="0.5" data-watch-once="" data-da=".hero-about-page__container, 992, 2" class="title"><?php echo CFS()->get('for-individuals_h1'); ?>
					</h1>
					<div class="hero-home-page__decor">
						<img src="<?php bloginfo('template_url'); ?>/assets/img/home/hero-decor.webp" alt="decor">
					</div>
				</div>
				<p data-watch="" data-watch-threshold="0.2" data-watch-once=""><?php echo CFS()->get('for-individuals_text'); ?>
				</p>
			</div>
			<div class="hero-about-page__right popup-cursor" data-popup='#popup-video' data-video-id='<?php echo esc_attr(CFS()->get('about-us_video')); ?>'>
				...
				<div class="hero-about-page__img">
					<img src="<?php echo CFS()->get('for-individuals_img'); ?>" alt="individuals">
				</div>
	...
	<section class="how-page__second second-how-page second-how-page-wdecor">
		<div class="second-how-page__container">
			<?php
			$team = CFS()->get('how-it-works_second_loop-ind');
			if ( $team ) :
			foreach ( $team as $member ) : ?>
			<div class="second-how-page__row second-how-page__row-reverce">
				<div class="second-how-page__img">
					<img src="<?php echo $member['how-it-works_second_img-1-ind']; ?>" alt="<?php echo $member['how-it-works_second_h2-1-ind']; ?>">
				</div>
				<div class="second-how-page__text">
					<h2 class="title" data-watch="" data-watch-threshold="0.5" data-watch-once=""><?php echo $member['how-it-works_second_h2-1-ind']; ?></h2>
					<p data-watch="" data-watch-threshold="0.5" data-watch-once=""><?php echo $member['how-it-works_second_text-1-ind']; ?></p>
					<?php if ( !empty($member['how-it-works_second_button-1-ind']) ) : ?>
						<a href="<?php echo esc_url($member['how-it-works_second_link-1-ind']); ?>" class="button button-fill">
							<?php echo esc_html($member['how-it-works_second_button-1-ind']); ?>
						</a>
					<?php endif; ?>
				</div>
			</div>
		...
		<div class="additional-home-page__container">
			...
			<a href="https://wa.me/19297762142" class="additional-home-page__right">
				<div class="additional-home-page__img">
					<img src="https://apostil.co/wp-content/uploads/2025/11/operator-3-e1762242733308.webp" alt="bot">
				</div>
	...
	<section class="how-page__second second-how-page second-how-page-wdecor">
		<div class="second-how-page__container">
			<?php
			$team = CFS()->get('how-it-works_second_loop-ind-2');
			if ( $team ) :
			foreach ( $team as $member ) : ?>
			<div class="second-how-page__row second-how-page__row-reverce">
				<div class="second-how-page__img">
					<img src="<?php echo $member['how-it-works_second_img-1-ind-2']; ?>" alt="<?php echo $member['how-it-works_second_h2-1-ind-2']; ?>">
				</div>
				<div class="second-how-page__text">
					<h2 class="title" data-watch="" data-watch-threshold="0.5" data-watch-once=""><?php echo $member['how-it-works_second_h2-1-ind-2']; ?></h2>
					<p data-watch="" data-watch-threshold="0.5" data-watch-once=""><?php echo $member['how-it-works_second_text-1-ind-2']; ?></p>
					<?php if ( !empty($member['how-it-works_second_button-2-ind']) ) : ?>
						<a href="<?php echo esc_url($member['how-it-works_second_link-2-ind']); ?>" class="button button-fill">
							<?php echo esc_html($member['how-it-works_second_button-2-ind']); ?>
						</a>
					<?php endif; ?>
				</div>
			</div>
	...
	<section class="about-page__second second-about-page">
		<div class="second-about-page__container">
			<div class="second-about-page__left">
				<span class="title" data-watch="" data-watch-threshold="0.5" data-watch-once=""><?php echo CFS()->get('for-individuals_why_choose_h'); ?></span>
				<p data-watch="" data-watch-threshold="0.5" data-watch-once=""><?php echo CFS()->get('for-individuals_why_choose_p'); ?></p>
			...
			<div class="second-about-page__right">
				<ul>
					<?php
						$team = CFS()->get('for-individuals_why_choose_loop');
						if ( $team ) :
						foreach ( $team as $member ) : ?>
						<li data-watch="" data-watch-threshold="0.5" data-watch-once="">
							<a href='<?php echo $member['for-individuals_why_choose_link']; ?>'>
							<div class="choose-home-page__li">
									<img src="<?php echo $member['for-individuals_why_choose_icon']; ?>" alt="<?php echo $member['for-individuals_why_choose_text']; ?>">
								</div>
								<p><?php echo $member['for-individuals_why_choose_text']; ?></p>	
							</a>
						</li>
						<?php endforeach;
						endif;
