		...
		<div class="hero-about-page__container">
			<div class="hero-about-page__left">
				<div class="hero-home-page__box">
					<h1 data-watch="" data-watch-threshold="0.5" data-watch-once="" data-da=".hero-about-page__container, 992, 2" class="title">Blog
					</h1>
		...
		<div class="categories-blog__container">
			<nav class="categories-blog__filter">
				<ul class="categories-blog__list">
					<li><a href="#" class="category-filter active" data-category="all">All ARTICLES</a></li>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const articles = document.querySelectorAll('.categories-blog__article');
    ...
    filterLinks.forEach(link => {
        link.addEventListener('click', function (e) {
            ...
            articles.forEach(article => {
                const cats = article.dataset.category;

                if (category === 'all') {
                    article.style.display = "";
                } else {
                    article.style.display = cats.includes(category) ? "" : "none";
                }
            });
        });
    });
