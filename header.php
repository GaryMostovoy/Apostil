...
<meta charset="UTF-8">
	...
	<meta name="apple-itunes-app" content="app-id=6756267706">
</head>
			...
			<div class="banner">
				<div class='banner__left'>
					<div class='banner__logo'>
						<img src='https://apostil.co/wp-content/uploads/2026/02/logo-apostil.webp' alt='logo'>
					</div>
					<div class='banner__text'>
						<p>Apostille & Record Retrieval</p>
						<span>Open in Apostil app and save 10%</span>
					</div>
				</div>
				<div class='banner__right'>
					<a href="#" class='app-link'>Get</a>
				</div>
			</div>
		</header>