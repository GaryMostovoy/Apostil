		...
		<div class="hero-about-page__container">
			...
			<div class="hero-about-page__right popup-cursor" data-popup='#popup-video' data-video-id='<?php echo esc_attr(CFS()->get('about-us_video')); ?>'>
				...
				<div class="hero-about-page__img">
					<img src="<?php echo CFS()->get('for-business_img'); ?>" alt="business">
				</div>
	...
	<section class="about-page__second second-about-page">
		<div class="second-about-page__container">
			<div class="second-about-page__left">
				<span class="title" data-watch="" data-watch-threshold="0.5" data-watch-once=""><?php echo CFS()->get('for-business_why_choose_h'); ?></span>
				<p data-watch="" data-watch-threshold="0.5" data-watch-once=""><?php echo CFS()->get('for-business_why_choose_p'); ?>
				</p>
			...
			<div class="second-about-page__right">
				<ul>
					<?php
						$team = CFS()->get('for-business_why_choose_loop');
						if ( $team ) :
						foreach ( $team as $member ) : ?>
						<li data-watch="" data-watch-threshold="0.5" data-watch-once="">
							<a href='<?php echo $member['for-business_why_choose_link']; ?>'>
							<div class="choose-home-page__li">
									<img src="<?php echo $member['for-business_why_choose_icon']; ?>" alt="<?php echo $member['for-business_why_choose_text']; ?>">
								</div>
								<p><?php echo $member['for-business_why_choose_text']; ?></p>	
							</a>
						</li>
						<?php endforeach;
						endif;
